...
function Menu(){
  return (
    ...
    <div className="card">
     <Image src="./public/assets/imagenes/pizzas/pizza1.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
     <div className="card">
     <Image src="./public/assets/imagenes/pizzas/pizza7.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
   <div className="card">
     <Image src="./public/assets/imagenes/pizzas/pizza3.jpg" fluid />
   ...
   <Col md={4} className="mb-2 ">
   <div className="card" >
     <Image src="./public/assets/imagenes/pizzas/pizza2.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
   <div className="card" >
     <Image src="./public/assets/imagenes/pizzas/pizza5.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
   <div className="card" >
     <Image src="./public/assets/imagenes/pizzas/pizza6.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
   <div className="card">
     <Image src="./public/assets/imagenes/pizzas/pizza9.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
     <div className="card">
     <Image src="./public/assets/imagenes/pizzas/pizza4.jpg" fluid />
   ...
   <Col md={4} className="mb-2">
   <div className="card" >
     <Image src="./public/assets/imagenes/pizzas/pizza8.jpg" fluid />
